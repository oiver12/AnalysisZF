...
\end{multicols*}
\begin{center}
    \includegraphics[height=0.99\textheight, width=\textwidth]{Bilder/Integrals_all.png}
\end{center}
\begin{center}
    \includegraphics[height=0.99\textheight, width=\textwidth]{Bilder/Integrals_all_2.png}
\end{center}
\begin{center}
    \includegraphics[height=0.99\textheight, width=\textwidth]{Bilder/Anhang_1.png}
\end{center}
